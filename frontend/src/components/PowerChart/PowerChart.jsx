...
//         // ถ้า kw_ts ไม่มีข้อมูล → ใช้เวลาปัจจุบันของเครื่อง (local time) และเพิ่มทุก 5 นาที
//         const kw_ts =
//           response.data.kw_ts && response.data.kw_ts.length > 0
//             ? response.data.kw_ts
//             : kw_values.map((_, index) => {
//                 const date = new Date();
//                 date.setMinutes(
//                   date.getMinutes() - 5 * (kw_values.length - index - 1)
//                 );
